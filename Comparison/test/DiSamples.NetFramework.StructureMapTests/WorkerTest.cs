...
using DiSamples.NetFramework.StructureMap;
using Microsoft.VisualStudio.TestTools.UnitTesting;
#endregion

namespace DiSamples.NetFramework.StructureMapTests
{
    /// <summary>
    ...
    public class WorkerTest
    {
        ...
        public void GetTimeTrackerTest()
        {
            ...
            //Assert
            Assert.IsNotNull(actual);
            Assert.AreSame(typeof(FullTimeEmployee), actual.Employee.GetType(), "Returned type was: " + actual.Employee.GetType().ToString());
        }
