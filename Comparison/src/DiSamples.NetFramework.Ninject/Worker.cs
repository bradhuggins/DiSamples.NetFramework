...
namespace DiSamples.NetFramework.Ninject
{
    ...
    public class Worker
    {
        ...
        public PayrollProcessor GetPayrollProcessor()
        {
            ...
            PayrollProcessor processorFTE = container.Get<PayrollProcessor>();
        ...
        public Authenticator GetAuthenticator()
        {
            ...
            Authenticator auth = container.Get<Authenticator>();
            return auth;
        }
        ...
        public TimeTracker GetTimeTracker()
        {
            ...
            //uses the FullTimeEmployee as dependecy
            TimeTracker timetracker = container.Get<TimeTracker>();
            return timetracker;
        }
