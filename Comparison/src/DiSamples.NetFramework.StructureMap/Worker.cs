...
namespace DiSamples.NetFramework.StructureMap
{
    ...
    public class Worker
    {
        ...
        public PayrollProcessor GetPayrollProcessor()
        {
            ...
            PayrollProcessor processorFTE = container.GetInstance<PayrollProcessor>();
        ...
        public Authenticator GetAuthenticator()
        {
            ...
            Authenticator auth = container.GetInstance<Authenticator>();
            return auth;
        ...
        public TimeTracker GetTimeTracker()
        {
            ...
            //uses the FullTimeEmployee as dependecy
            TimeTracker timetracker = container.GetInstance<TimeTracker>();
            return timetracker;
        }
